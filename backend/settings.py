...
# ── REST Framework ───────────────────────────────────────────────────────
# ✅ FIX INSPECTION BUG : DEFAULT_PARSER_CLASSES ajouté
REST_FRAMEWORK = {
    ...
    # ✅ CORRECTION : sans ces 3 parsers → "Type de média non supporté"
    'DEFAULT_PARSER_CLASSES': [
        'rest_framework.parsers.JSONParser',       # ← JSON (fetch/axios)
        'rest_framework.parsers.MultiPartParser',  # ← FormData (fichiers)
        'rest_framework.parsers.FormParser',       # ← Form standard
    ],
}
